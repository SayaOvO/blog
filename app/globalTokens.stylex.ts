...
export const colors = stylex.defineVars({
  bg: "linear-gradient(to bottom, #ffffff, #ece9e6, #ffffff)",
  bg1: "#f2fcfe",
  title: "#64748b",
  primary: "#334155",
  secondary: "#94a3b8",
  hoverBg: "rgba(236,233,230, 0.4)",
  border: "#e6dfd9",
})

export const shadows = stylex.defineVars({
  main:"3px 3px 4px rgba(236, 233, 230, 80%)",
  bottom: "0 4px 10px rgba(0,2,4,.06),0 0 1px rgba(0,2,4,.11)"
})